...
(1, 'Varshil', 'Falgunbhai', 'Shah', 'varshilshah44@gmail.com', '9428712306', 'varshilshah', 'varshil.JPG', 2, 6548),
...
INSERT INTO `issuetbl` (`issueId`, `issueData`, `issueImg`, `issueStatus`, `empId`, `issueTime`, `projectId`, `issuePriority`) VALUES
(1, 'Login Component', 'image1', 'pending', 1, '2020-03-09 05:15:09', 39, 'high'),
(2, 'qqqq', 'image2', 'resolved', 2, '2020-03-18 07:16:35', 31, 'medium'),
(3, 'ss', 'image3', 'pending', 3, '2020-03-18 03:16:22', 39, 'high'),
(4, 'Project View Component', 'image4', 'pending', 1, '2020-03-31 03:13:15', 39, 'high'),
(5, 'yy', 'image5', 'responded', 5, '2020-03-24 03:10:14', 39, 'low');
...
(1, 'Module1', 31, '5', '2020-02-01', '2020-02-04', 'Ready to deploy', 'module1'),
(2, 'Login', 31, '5', '2020-02-01', '2020-02-04', 'Ready to deploy', 'login module che aa'),
(3, 'login', 35, '5', '2020-03-29', '2020-04-08', 'Ready to deploy', 'Login for hotel'),
(4, 'forget password', 35, '2', '2020-03-29', '2020-03-31', 'Ready to deploy', 'Forget password for Hotel'),
(5, 'project View', 39, '5', '2020-03-29', '2020-04-03', 'Ready to deploy', 'Project view in Tables'),
(6, 'project Details', 39, '3', '2020-04-04', '2020-04-07', 'idle', 'Create Project Details'),
...
(10, 'Login', 32, '5', '2020-05-04', '2020-05-09', 'inprogress', 'login component');
...
(38, 'Clothes', 'varshil shah', 'Ecommerce', '2020-06-24', '2020-08-21', '2020-08-31', '2020-07-09', 3, 'cancelled', 'projectFile-1584770474080.pdf'),
...
(34, 'Software For calculating Tax', 'Software for Calculating Tax', 'ERP System', '2020-03-20', '2020-04-08', '2020-04-13', '2015-03-11', 5, 'Ready to deploy', 'projectFile-1584699243224.sql'),
...
(35, 'Hotel Booking', 'abc', 'Static Website', '2020-03-21', '2020-05-14', '2020-06-01', '2020-03-07', 4, 'Ready to deploy', 'projectFile-1584765477168.docx'),
...
(1, 1, 'sub1', 'model1', '2020-02-10', '2020-02-14', '5', 'Ready to deploy'),
(2, 1, 'sub2', 'model2', '2020-02-24', '2020-02-26', '3', 'Ready to deploy'),
(3, 2, 'validations', 'validation', '2020-02-01', '2020-02-02', '2', 'Ready to deploy'),
(4, 2, 'forgot', 'forgot', '2020-02-01', '2020-02-05', '3', 'Ready to deploy'),
(5, 1, 'login', 'login submodule', '2020-02-05', '2020-02-24', '20', 'Ready to deploy'),
(7, 1, 'submodule', 'submodule', '2020-02-01', '2020-02-02', '1', 'Ready to deploy'),
(8, 1, 'submodule1', 'submodule1', '2020-02-01', '2020-02-02', '1', 'Ready to deploy'),
(9, 1, 'varshilSubmodule', 'varshil', '2020-02-01', '2020-02-02', '1', 'Ready to deploy'),
(10, 1, 'hey', 'hey', '2020-02-23', '2020-02-24', '1', 'Ready to deploy'),
(16, 5, 'Designing', 'Make Design for Project view module', '2020-03-29', '2020-03-31', '3', 'Ready to deploy'),
(11, 3, 'Design For Login', 'Do Designing for login page', '2020-03-30', '2020-04-02', '4', 'Ready to deploy'),
(12, 3, 'validation', 'Make perfect Validation for login page', '2020-03-03', '2020-03-04', '1', 'Ready to deploy'),
(13, 3, 'Testing', 'Do Testing if its works fine or not', '2020-03-05', '2020-03-06', '1', 'Ready to deploy'),
(14, 4, 'forgetPage Design', 'Do Designing for Forget password', '2020-03-29', '2020-03-30', '1', 'Ready to deploy'),
(15, 4, 'validation', 'validate forget password', '2020-03-31', '2020-04-01', '1', 'Ready to deploy'),
(17, 5, 'Coding', 'coding for project view', '2020-04-01', '2020-04-04', '4', 'Ready to deploy'),
(18, 6, 'Designing', 'make design for project details', '2020-03-29', '2020-03-31', '3', 'Ready to deploy'),
(19, 6, 'validation', 'validate design', '2020-03-30', '2020-03-31', '1', 'Ready to deploy'),
(20, 7, 'Designing', 'make design', '2020-03-29', '2020-03-30', '1', 'Ready to deploy'),
